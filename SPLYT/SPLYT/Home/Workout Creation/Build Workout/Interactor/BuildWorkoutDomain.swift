...
final class BuildWorkoutDomain: Equatable {
  ...
  init(
    exercises: [String: AvailableExercise],
  ...
  static func == (lhs: BuildWorkoutDomain, rhs: BuildWorkoutDomain) -> Bool {
    return lhs.exercises == rhs.exercises && lhs.builtWorkout == rhs.builtWorkout
      && lhs.currentGroup == rhs.currentGroup && lhs.filterDomain == rhs.filterDomain
      && lhs.canSave == rhs.canSave && lhs.isCreatingSuperset == rhs.isCreatingSuperset
  }
}
